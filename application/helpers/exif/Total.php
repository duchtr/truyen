...
function read_xml_array_from_text( $xmltext )
{
        ...
        $a = $i=0;
        return xml_get_children($newvals, $a);
...
$GLOBALS[ "Software Name" ] = "Tech5s Metadata v" . $GLOBALS['Toolkit_Version'] . " - hungvt1804@gmail.com";          // Change:  Changed version numbers to reference Toolkit_Version.php - as of version 1.11
                                ...
                                if( array_key_exists( 'children', $Item['children'][0] ))
{
                                ...
                                foreach ( $Item['children'][0]['children'] as $keywords )
                                {
                                        ...
                                        if ( array_key_exists("value", $keywords) &&  ! in_array ( HTML_UTF8_Escape( $keywords['value'] ), $outputarray['keywords']))
                                        {
        ...
        if ( $photoshop_block != FALSE )
        {
                ...
                if ( $Item != FALSE )
                {
                        ...
                        if  ( ( array_key_exists( 'children', $Item ) ) && ( $Item['children'][0]['tag'] =="rdf:Bag" ) && array_key_exists( 'children', $Item['children'][0] )  )
                        {
