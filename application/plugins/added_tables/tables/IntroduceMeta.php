...
class IntroduceMeta{
	...
	private function addTable(){
		...
		$dttable->addField("id","int","id");$dttable->addField("name","varchar(255)","name");$dttable->addField("content","varchar(255)","content");$dttable->addField("ord","varchar(255)","ord");$dttable->addField("act","tinyint","act");$dttable->addField("update_time","text(65535)","update_time");$dttable->addField("create_time","text(65535)","create_time");$dttable->addField("link","text(65535)","link");
		$dttable->build();
	}
	...
	private function createModule(){
		...
		$m->insertGroupModule('Giới thiệu',"view/".$this->table,32,'icon-camera',2);
	}
