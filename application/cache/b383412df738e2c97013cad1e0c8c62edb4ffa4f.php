<header>
    ...
    <div class="top_header md_hidden <?php if($pp!=''): ?> color_xanh <?php endif; ?>">
        <div class="container">
    ...
    <div class="mid_header">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-6 col-sm-7 col-md-7 col-lg-2 px-lg-0 d-lg-block d-flex align-items-center position-static justify-content-between">
                    <span class="show-search d-lg-none d-block d-md-none">
