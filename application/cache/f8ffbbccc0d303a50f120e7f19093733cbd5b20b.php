...
<div class="slider  tiny-slider" data-slide-by ='page' data-items='2' data-auto_height="true" data-mouse-drag='true' data-controls='false' data-autoplay-button-output='false' data-nav='true' data-center='true' data-autoplay='true' data-responsive ='{"1":{"items":"2"},"480":{"items":"2"},"767":{"items":"1"},"991":{"items":"2"}}' >
  <?php
    ...
    <div class="img_slide relative">
      <div class="cover_img">
        <a class="c-img img-center" title="<?php echom($itempro1,'name',1); ?>" href="<?php echom($itempro1,'slug',1); ?>">
          <?php echo imgv2($itempro1,'#W#img','1',-1) ; ?>        </a> 
      </div>
    </div>
        ...
        <div class="">
          <div class="item_pro_cate">
            <a href="<?php echom($itempro_categories1,'slug',1); ?>" class="img_pro_cate">
              <?php echo imgv2($itempro_categories1,'#W#img','-1',false) ; ?>            </a>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="item_pro_big box_shadow">
            <a href="<?php echom($itempro_home,'slug',1); ?>" class="c-img">
              <?php echo imgv2($itempro_home,'#w#img','-1',1) ; ?>            </a>
            <div class="text">
